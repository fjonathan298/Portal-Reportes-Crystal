...
Public Class XtremeCustomers
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VB_Win_ReducedCode_ProjectSetup.XtremeCustomers.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedXtremeCustomers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As XtremeCustomers = New XtremeCustomers()
        rpt.Site = Me.Site
        Return rpt
    End Function
