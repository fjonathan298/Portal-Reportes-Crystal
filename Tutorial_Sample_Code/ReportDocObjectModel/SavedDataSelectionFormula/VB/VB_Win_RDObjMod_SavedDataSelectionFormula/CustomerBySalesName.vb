...
Public Class CustomerBySalesName
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VB_Win_RDObjMod_SavedDataSelectionFormula.CustomerBySalesName.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCustomerBySalesName
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CustomerBySalesName = New CustomerBySalesName()
        rpt.Site = Me.Site
        Return rpt
    End Function
