...
Public Class Hierarchical_Grouping
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VB_Win_Multilingual.Hierarchical Grouping.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHierarchical_Grouping
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Hierarchical_Grouping = New Hierarchical_Grouping()
        rpt.Site = Me.Site
        Return rpt
    End Function
