...
Public Class CustomersViaIDR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VB_Win_Data_IDataReader.CustomersViaIDR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCustomersViaIDR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CustomersViaIDR = New CustomersViaIDR()
        rpt.Site = Me.Site
        Return rpt
    End Function
