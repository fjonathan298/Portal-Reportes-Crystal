...
Public Class CustomersByCity
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VB_Win_CRVObjMod_ParametersSubrpt.CustomersByCity.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CustomerOrders_OrderDateRange() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCustomersByCity
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CustomersByCity = New CustomersByCity()
        rpt.Site = Me.Site
        Return rpt
    End Function
