...
<body>
    ...
    <div>
        <table style="width: 100%">
            ...
            <tr>
                <td nowrap="nowrap" style="width: 100px" valign="top">
                    <asp:Button ID="redisplay" runat="server" Text="Redisplay Report" /></td>
                <td nowrap="nowrap" style="width: 100px" valign="top">
                </td>
                <td nowrap="nowrap" style="width: 100px" valign="top">
                </td>
            ...
            <tr>
                ...
                <td nowrap="nowrap" style="width: 100px" valign="top">
                    <asp:Button ID="goToPage" runat="server" Text="Go to Page" /></td>
                <td nowrap="nowrap" style="width: 100px" valign="top">
                    <asp:TextBox ID="zoomFactor" runat="server"></asp:TextBox></td>
                <td nowrap="nowrap" style="width: 100px" valign="top">
                    <asp:Button ID="updateZoomFactor" runat="server" Text="% Zoom" /></td>
            </tr>
            <tr>
                <td nowrap="nowrap" style="width: 100px" valign="top">
                    <asp:TextBox ID="searchText" runat="server"></asp:TextBox></td>
                <td nowrap="nowrap" style="width: 100px" valign="top">
                    <asp:Button ID="search" runat="server" Text="Search For Text" /></td>
                <td nowrap="nowrap" style="width: 100px" valign="top">
            ...
            <tr>
                ...
                <td nowrap="nowrap" style="width: 100px" valign="top">
                    <asp:Button ID="drawBorder" runat="server" Text="Draw Border" /></td>
            </tr>
        </table>
        <br />
