...
Public Class CustomersBySalesName
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VB_Win_CRVObjMod_FilteringData.CustomersBySalesName.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCustomersBySalesName
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CustomersBySalesName = New CustomersBySalesName()
        rpt.Site = Me.Site
        Return rpt
    End Function
